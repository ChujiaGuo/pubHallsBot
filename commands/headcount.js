...
exports.run = async (client, message, args, Discord) => {
    ...
    for (var i in chosenTemplate.specialReacts) {
        await hcMessage.react(chosenTemplate.specialReacts[i]).catch(e => e.toString().includes("Error") ? errorHelper.report(message, client, e):null)
    }
    ...
    for (var i in runTemplates.global.special) {
        await hcMessage.react(runTemplates.global.special[i]).catch(e => e.toString().includes("Error") ? errorHelper.report(message, client, e):null)
    }
}